...
# Difficulty menu
difficulties = ["facile", "normal", "difficile", "god-like"]


# Arrow Difficulty
arrow_left_png = pygame.image.load("arrow_left.png").convert_alpha()
arrow_right_png = pygame.image.load("arrow_right.png").convert_alpha()
...
def menu():
    ...
    while running:
        ...
        difficulty_button = draw_button((center_x - 150), (center_y + 110), 300, 70, GRAY, window)
